...
class Inserter:
    def __init__(self, eps,spatial_eps, min_pts, objects):
        self.eps = eps
        self.spatial_eps = spatial_eps
        self.min_pts = min_pts
        self.objects = objects

    def insert(self, object_value,object_point):
        object_inserted = self.objects.insert_object(object_value,object_point)
